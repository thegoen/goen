  ...
  $('.product:not(.field_loaded)').each(function () {
    ...
    if ($product.hasClass('is_post')) {
      ...
      productUiHtml += '                <button type="button" class="cart-add">'
        ...
        + '                        <path d="M352 176V144c0-53-43-96-96-96s-96 43-96 96v32H80a32 32 0 00-32 32v224a48 48 0 0048 48h320a48 48 0 0048-48V208a32 32 0 00-32-32zm-160-32c0-35.3 28.7-64 64-64s64 28.7 64 64v32H192zm240 288a16 16 0 01-16 16H96a16 16 0 01-16-16V208h352z" />'
        + '                    </svg>'
